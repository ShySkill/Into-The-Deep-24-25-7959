...
public class PinpointDrive extends MecanumDrive {
    public static class Params {
         ...
         */
        //track width is 13 inches
        //length of the robot is 15.0625 inches
        //width of robot is 15.4 inches
        ...
        public double xOffset = -2.3125;
        //need to tune the X acorrdinly
        //x is 4.25 from the top, and 2 inches from the side
        //y
        //center of the robot is 7.5625 inches for the y value
        //center of the robot is 7.53 for the x value
        //lateral distance from pod to pod (distance between pods) is 5.625

        public double yOffset = -5.2313;
