...
public class FConstants {
    static {
        ...
        //voltage changes, we tu
        FollowerConstants.useVoltageCompensationInAuto = true;
        FollowerConstants.nominalVoltage = 12.8;



        FollowerConstants.xMovement = 68.1417;
        FollowerConstants.yMovement = 48.6505;

        FollowerConstants.forwardZeroPowerAcceleration = -30.146;
        FollowerConstants.lateralZeroPowerAcceleration = -75.7743;
